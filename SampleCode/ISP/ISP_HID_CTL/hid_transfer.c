...
#else
extern volatile uint8_t response_buff[64] __attribute__((aligned(4)));
volatile uint8_t usb_rcvbuf[64] __attribute__((aligned(4)));
#endif
...
void HID_ClassRequest(void)
{
    ...
    if (buf[0] & 0x80)   /* request data transfer direction */
    {
        ...
        case GET_REPORT:
                    ...
                    //response_buff[i] = i+1;
                g_SendLen = 65;
                USBD_MemCopy((uint8_t *)(USBD_BUF_BASE + USBD_GET_EP_BUF_ADDR(EP0)), (uint8_t *)&response_buff, g_SendLen);

                /* Data stage */
                USBD_PrepareCtrlIn((uint8_t *)response_buff, g_SendLen);
                /* Status stage */
        ...
        case SET_REPORT:
        {
            if (buf[3] == 3)
            {
                ...
                USBD_SET_PAYLOAD_LEN(EP1, 0);
						...
						set_report_flag = 1;
						USBD_PrepareCtrlOut((uint8_t *)&usb_rcvbuf, u32Len);
